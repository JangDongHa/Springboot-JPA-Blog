...
public class HttpControllerTest {
	...
	public String getTest(Member m) { // Member m Mapping : MessageConverter
		return "This is Get Test" + " " + m.getId() + " " + m.getUsername() + " " + m.getPassword() + " "
				+ m.getEmail();
	}
	...
	public String postTest(@RequestBody Member m) { // Member m Mapping : MessageConverter
		return "This is Post Test" + " " + m.getId() + " " + m.getUsername() + " " + m.getPassword() + " "
				+ m.getEmail();
	}
	...
	public String putTest(@RequestBody Member m) {
		return "This is Put Test" + " " + m.getId() + " " + m.getUsername() + " " + m.getPassword() + " "
				+ m.getEmail();
	}
